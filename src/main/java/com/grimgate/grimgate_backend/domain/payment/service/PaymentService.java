...
public class PaymentService {
     ...
     * 
     * <p><b>[이슈 #48 비즈니스 요구사항]</b></p>
     * <ul>
     *   <li>Toss 결제창 요청 전, 금액 위변조 및 중복 결제 요청 방지를 위한 검증을 수행합니다.</li>
     *   <li>결제 최종 승인(confirm), 웹훅(webhook), 결제 실패/환불(cancel) 처리는 본 이슈 범위에서 제외하며 후속 이슈로 처리합니다.</li>
     * </ul>
     *
